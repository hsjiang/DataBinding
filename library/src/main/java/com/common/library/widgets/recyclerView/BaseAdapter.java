...
public abstract class BaseAdapter<Item extends Serializable, VH extends BaseViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    protected VH createViewViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewDataBinding binding = DataBindingUtil.inflate(inflater, getLayoutId(viewType), parent, false);
        VH viewHolder = getViewHolder(binding.getRoot(), viewType);
        viewHolder.setDataBinding(binding);
        return viewHolder;
    }

    @Override
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        return createViewViewHolder(parent, viewType);
    }
