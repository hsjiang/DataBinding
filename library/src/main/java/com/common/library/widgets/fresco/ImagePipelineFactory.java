...
public class ImagePipelineFactory {
    ...
    public static ImagePipelineConfig imagePipelineConfig(Context context, OkHttpClient okHttpClient) {
    ...
    private static ImagePipelineConfig configureCaches(Context context, OkHttpClient okHttpClient) {
        ...
        DiskCacheConfig diskSmallCacheConfig = DiskCacheConfig.newBuilder(context)
                .setBaseDirectoryPath(new File(cachePath, file).getAbsoluteFile())//缓存图片基路径
